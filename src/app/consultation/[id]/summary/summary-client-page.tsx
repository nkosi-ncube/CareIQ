...
function SummaryClientPage({ consultationId }: { consultationId: string }) {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
        setIsLoading(true);
        const result = await getConsultationSummary(consultationId);
        if (result.success) {
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
                 <Select onValueChange={handleLanguageChange} defaultValue="eng_Latn">
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="ha_Latn">Hausa</SelectItem>
                        <SelectItem value="yor_Latn">Yoruba</SelectItem>
                        <SelectItem value="ibo_Latn">Igbo</SelectItem>
                        <SelectItem value="amh_Ethi">Amharic</SelectItem>
                    </SelectContent>
                </Select>
...
export default SummaryClientPage;
